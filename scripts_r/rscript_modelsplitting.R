...
source_string <- paste(params_root_string, model_string, ".R",  sep="")
...
splitted_data <- f_pack_split_data(dataset_loaded$X, dataset_loaded$y, Pparams = Pparams, ssplits=ssplits, iseed= task_id, typesplit=typesplit)
